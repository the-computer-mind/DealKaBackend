...
router.post('/seller_productavailable',  async (req, res ) => {

    console.log('connection of seller_avalibe check done');
    console.log(req.body);
    // res.status(201).send("url");
    //validating jwttoken
    try {
      console.log("enteringggg to Seller_productavailable");
      var newHeaders = [];
