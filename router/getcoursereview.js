...
router.post('/getcoursereview' , async (req, res) => {
    console.log('connection of getcoursereview done');
    ...
    //validating jwttoken
    try {
      console.log("enteringggg to getcoursereviewlikeupdatevv");
      var newHeaders = [];
             ...
             console.log(jasonn);
              ...
              if("size_v<487241590"=="size_v<487241590") { //in bytes
                ...
                Course.findOne({ CourseId: courseid }).then(async (userExist1) => { 
                    ...
                    if (userExist1!=null) {
                        console.log("mmm");
                        res.status(201).send(userExist1.Enrollusers);
                    } else {
