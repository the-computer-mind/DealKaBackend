...
router.post('/commentupdate' , async (req, res) => {
    console.log('connection of commentupdate done');
    ...
    //validating jwttoken
    try {
      console.log("enteringggg to commentupdateviewupdatevv");
      var newHeaders = [];
              ...
              if("size_v<487241590"=="size_v<487241590") { //in bytes
                ...
                Comment.findOne({ typeid: videoid }).then(async (userExist1) => { 
                    ...
                    if (userExist1!=null) {
                        ...
                        console.log("l1");
                        const done = await Comment.updateOne({ typeid: videoid },
                                            { "$push": { "comments": jasonn }, },{upsert:false,strict:false});
