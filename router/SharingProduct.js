...
router.post('/Sharingproductmodel',  async (req, res ) => {

    console.log('connection of Sharingproductmodel');
    console.log(req.body);
    // res.status(201).send("url");
    //validating jwttoken
    try {
      console.log("enteringggg to Sharingproductmodel");
      var newHeaders = [];
        ...
        if (devicenum == 1 || devicenum == 2 || devicenum == 3 || devicenum == 4 || devicenum == 0) {
            console.log('under refer==true');
             ...
             Product.aggregate([
                ...
                {$match: {'products.ProductId':orderid}},
