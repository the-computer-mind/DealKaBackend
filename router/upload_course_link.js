...
router.post('/uploadcourselink' , async (req, res) => {
    console.log('connection of uploadcourselink done');
    console.log(req.body);
    // res.status(201).send("url");
    //validating jwttoken
    try {
      console.log("enteringggg to courseuploadbylink");
      var newHeaders = [];
              ...
              if(user.UserRole=="Admin" || user.UserRole=="SemiAdmin" ||  user.UserRole=="Moderator") { //in bytes
                ...
                Course.findOne({ CourseId: jasonn.CourseId }).then(async (videoexist) => {
                 ...
                 console.log(jasonn.Enrollusers);
                        ...
                        const cours = await Course.findOne({ CourseId: jasonn.CourseId});
                     ...
                     console.log(jasonn.Enrollusers);
                        ...
                        res.status(201).send("delete wrong");
