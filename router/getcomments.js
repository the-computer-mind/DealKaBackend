...
router.post('/getcomments' , async (req, res) => {
    console.log('connection of getcomments done');
    ...
    //validating jwttoken
    try {
      console.log("enteringggg to getcommentslikeupdatevv");
      var newHeaders = [];
                ...
                Comment.findOne({ typeid: videoid }).then(async (userExist1) => { 
                    ...
                    if (userExist1!=null) {
                        ...
                        const comm = new Comment({
                            ...
                            const videoinfo = await comm.save()
