...
router.post('/Delivery_Response',  async (req, res ) => {

    console.log('connection of Delivery_Response check done');
    console.log(req.body);
    // res.status(201).send("url");
    //validating jwttoken
    try {
      console.log("enteringggg to Delivery_Response");
      var newHeaders = [];
