...
router.post('/Shipment_Tracking_update',  async (req, res ) => {

    console.log('connection of Shipment_Tracking_update check done');
    console.log(req.body);
    // res.status(201).send("url");
    //validating jwttoken
    try {
      console.log("enteringggg to Shipment_Tracking_update");
      var newHeaders = [];
