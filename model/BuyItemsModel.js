...
const UserBuyModelSchema = new mongoose.Schema({
    name: {
        type: String,
        required: true,
        unique: true
    ...
    primeMemberRefundStatus: {
        type: String,
        required: true
    },
    primememberPurchasedate:{
        type: String,
        required: true
    },
    primemembershipname:{
...
module.exports = UserBuyModel = mongoose.model('UserBuy', UserBuyModelSchema);